...
- [Configurations](#configurations)
  - [EC2 User Data for Web Server](#ec2-user-data-to-add-web-server-with-web-page-on-80-port-number)
  - [Docker Remote API](#enable-docker-remote-api)
  - [VIM Configuration](#configuring-vim-according-to-our-needs)
  - [Git Authentication](#automate-git-password-authentiation)
  - [Chrome Command for Windows](#adding-personalized-google-chrome-command-for-windows)
  - [Git Commit Tree Alias](#adding-alias-to-view-commit-tree-of-git-in-cui-shellconsole)
  - [Rsync Backup](#setting-up-rsync-to-backup-data)
  - [Static IP Configuration](#setting-static-ip-in-local-network)
  - [VirtualBox IP](#making-virtualbox-ip-permanent)
  - [Linux Boot Configuration](#setting-linux-to-bootup-with-multicores)
  - [Ubuntu Boot Speed](#speeding-up-ubuntu-boot-speed)

- [Tasks](#tasks)
  - [Disk Performance](#check-disk-or-usb-or-mounted-device-performance)
  - [Temperature Check](#check-temperature)
  - [Docker Format](#change-default-format-of-docker-ls-or-docker-ps)
  - [Debian in Docker](#run-debian-command-via-docker)
  - [CSV in Terminal](#view-csv-file-in-terminal)
  - [Text File Management](#replace-part-of-text-file-with-content-from-another-file)
  - [Video Audio Management](#merge-audio-from-different-video-to-other-video-file)
  - [Video Size Reduction](#reduce-video-size)
  - [SSL Certificates](#creating-ssl-certificate--certificate-authority--self-sign-certificate)
  - [Gmail Setup](#setup-gmail-to-allow-other-applications-to-send-mail-on-your-behalf)
  - [Port Usage](#check-which-port-is-used-by-which-application)
  - [DEB Installation](#install-a-deb-file-from-terminal)
  - [Notifications](#making-notify-send-work-in-shell-to-make-notify-send-work-in-cron-ie-crontab-and-ssh)

- [Installations](#installations)
  - [Environment Setup](#installation-scripts-to-setup-environment)
  - [PHP in WAMP](#adding-new-php-version-in-wamp-server)
  - [LAMPP](#installing-lampp)
  - [LEMP](#installing-lemp)
  - [Composer](#installing-composer-in-linux)
  - [Laravel](#installing-laravel)
  - [Java](#installing-java-manually)
  - [Package Management](#uninstall-a-package-properly-on-ubuntu)
  - [PostgreSQL Debugger](#installing-postgresql-debugger)
  - [Maven](#maven-download--install-sources-and-javadocs)
  - [MongoDB](#mongodb-on-ubuntu-160)
  - [System Services](#generic-runnableexecutable-fileapplication-as-service-in-ubuntu)

- [Setup](#setup)
  - [Service Management](#disabling-lightdm-or-other-service)
  - [SSH Security](#disable-ssh-login-without-password)
  - [Git SSH](#setting-git-to-login-wihout-password--using-ssh-in-git)
...
- [Code](#code)
  - [Environment Variables](#to-read-env-file-to-set-environment-variables)
  - [File Change Trigger](#trigger-code-on-file-change)
  - [Email with Python](#python-code-to-send-a-simple-text-email)
  - [Page Number Converter](#python-code-for-page-number-converter)
  - [XMLHttpRequest Interceptor](#intercept-requests-of-xmlhttprequest)
